...
data analysis is included in the project source code. \todo{add to code}
...
\textttt{benchmark.log}, and store them in the same directory. For the script
to work, you have to delete the first and last line of \texttt{varable.log}
where no actions are selected.
