...
converge to optimal policies over time. However, Q-learning is believed to be
limited in complex environments as it cannot simulate possible courses of
action. \parencite{Russell2010ai+modern}
