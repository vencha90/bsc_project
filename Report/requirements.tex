...
\todo{Public transport actions are determined by agents trying to reach some
        objective e.g. maxium profit.}
...
means. When the simulation is expanded to multiple taxis \todo{extend this
section}
...
\todo{note what data exactly needs recording}
