...
relationship is complex in taxi market. Therefore an equilibrium cannot be
...
efficiency. The exact tariff can be calculated by fixing probability
...
\begin{tabular}{| p{0.15 \textwidth} | p{0.8 \textwidth} |}
  ...
  location. If the offer is accepted, the taxi drives the passenger to their
