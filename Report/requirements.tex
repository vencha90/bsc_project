...
\todo{High level overview first?}


\subsection{Functional Requirements}
\label{sec:requirements:simulation}

The following requirements follow directly from the project's goals set in
Section \ref{sec:intro:goals}. This section aims to formalise the goals in
great detail. Alas, it is unfeasible to structure this section around each goal
as they contain several requrements that sometimes overlap with other goals.
...
preferrable as it allows individual modelling of passengers. \todo{claim needs
backing this claim!} Of course, to express demand as a single variable it needs
