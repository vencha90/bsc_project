...
description in Section \ref{sec:design:architecture}. Besides a detailed look
at the software modules, this section is concluded by an overview of known
limitations and issues with the current implementation.
...
A less important issue is the taxi action sequence not mimicking real world
